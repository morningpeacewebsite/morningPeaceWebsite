  ...
  return (
    <div className="w-full min-h-screen flex flex-col" style={{background: '#FCF5EF'}}>
      ...
      <div className="w-full flex items-center justify-center min-h-[220px] md:min-h-[320px] bg-gradient-to-b from-[#FEA735] to-[#FE7235]">
        <h1 className="text-5xl md:text-6xl font-extrabold text-white drop-shadow-lg text-center">Annuities and Income Solutions</h1>
      </div>
      ...
      <div className="w-full py-12 px-4 flex flex-col items-center flex-1">
        <div className="w-full max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h2 className="text-3xl font-bold text-[#FE7235] mb-6">Why Consider Annuity for Your Retirement?</h2>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h3 className="text-2xl font-semibold text-[#FE7235] mb-4">How an Annuity Works</h3>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h3 className="text-2xl font-semibold text-[#FE7235] mb-4">Buying an Annuity</h3>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h3 className="text-2xl font-semibold text-[#FE7235] mb-4">A Smart Addition to Your Plan</h3>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h3 className="text-2xl font-semibold text-[#FE7235] mb-4">FIXED INDEX ANNUITY</h3>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h3 className="text-2xl font-semibold text-[#FE7235] mb-4">THE COMMITMENT OF A FIXED ANNUITY</h3>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h3 className="text-2xl font-semibold text-[#FE7235] mb-4">IMMEDIATE AND DEFERRED ANNUITIES</h3>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Planning for steady income in retirement is easier with an immediate or deferred annuity. It offers peace of mind by protecting your money and providing predictable payments, helping you feel more secure about your financial future.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              An immediate annuity is a contract between you and insurance company where you make a one-time payment, and income payments begin within 12 months. You can choose to receive guaranteed income for life or for a fixed period (from 5 to 25 years). With several payout options available, you can pick a plan that best fits your retirement goals and needs.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
